...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_status'])) {
    ...
    if ($order_id > 0 && !empty($new_status)) {
        $stmt = $conn->prepare("UPDATE orders SET order_status = ? WHERE order_id = ? AND kitchen = 'neptune'");
        if ($stmt) {
...
// Fetch all orders for Neptune Kitchen with customer details
$orders = [];
$sql = "SELECT o.*, c.username, c.fullname, c.email, c.phone AS customer_phone 
    FROM orders o 
...
<head>
    ...
    <title>Neptune Kitchen - Order Management</title>
...
<body class="bg-gray-50 text-gray-900">
    ...
    <header class="h-16 flex items-center">
        <div class="relative h-full w-full max-w-7xl mx-auto px-4">
            ...
            <nav class="nav-buttons">
                ...
                <a href="./order.php" class="px-4 py-2 rounded text-sm bg-red-600 bg-opacity-80">Order</a>
            </nav>
    ...
    <section id="hero" class="hero">
        ...
        <div class="relative z-10 max-w-4xl mx-auto px-4 py-24 text-center text-white">
            ...
            <p class="text-lg text-gray-200">Neptune Kitchen Orders</p>
        </div>
    </section>
