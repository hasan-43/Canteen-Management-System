...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_status'])) {
    ...
    if ($order_id > 0 && !empty($new_status)) {
        $stmt = $conn->prepare("UPDATE orders SET order_status = ? WHERE order_id = ? AND kitchen = 'khans'");
        if ($stmt) {
...
// Fetch all orders for Khans Kitchen with customer details
$orders = [];
...
<head>
    ...
    <title>Khans Kitchen - Order Management</title>
...
<body class="bg-gray-50 text-gray-900">
    ...
    <section id="hero" class="hero">
        ...
        <div class="relative z-10 max-w-4xl mx-auto px-4 py-24 text-center text-white">
            ...
            <p class="text-lg text-gray-200">Khans Kitchen Orders</p>
        </div>
    </section>
