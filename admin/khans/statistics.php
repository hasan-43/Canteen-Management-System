...
$sqlRevenue = "SELECT DATE(order_date) as od, SUM(total_amount) as rev
               FROM orders
               WHERE LOWER(kitchen) = 'khans' AND order_status = 'delivered'
...
$sqlStatus = "SELECT order_status, COUNT(*) AS c FROM orders WHERE LOWER(kitchen) = 'khans' GROUP BY order_status";
...
$sqlRecent = "SELECT pr.*, k.name as product_name, c.fullname, 
              ...
              JOIN khans k ON pr.product_code = k.product_code
              JOIN customer c ON pr.customer_id = c.customer_id
              WHERE pr.kitchen = 'khans'
...
<HEAD>
    ...
    <title>Khans Kitchen - Statistics</title>
...
<body class="bg-gray-50 text-gray-900">
    ...
    <section id="hero" class="hero">
        ...
        <div class="relative z-10 max-w-4xl mx-auto px-4 py-20 text-center text-white">
            ...
            <p class="text-lg text-gray-200">Sales performance for Khans Kitchen</p>
        </div>
    </section>
