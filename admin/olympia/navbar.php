<?php
// admin/olympia/navbar.php
// Olympia admin homepage with customer-like navbar plus statistics
...
<HEAD>
	...
	<title>Home - Olympia Admin - Campus Cravings</title>
	...
	<section id="hero" class="hero">
		...
		<div class="hero-content">
			<div class="max-w-4xl mx-auto px-4 text-center">
				...
				<p class="text-gray-200 mb-6">Manage Olympia Kitchen — track statistics and orders just like your customers see the site.</p>
