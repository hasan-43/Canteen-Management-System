...
$countSql = "SELECT COUNT(*) as total FROM orders WHERE LOWER(kitchen) = '{$shopTable}' AND order_status = 'delivered'";
...
// Fetch delivered orders (paginated)
$orders = [];
$totalRevenue = 0.0;
...
$revSql = "SELECT SUM(total_amount) as total_rev FROM orders WHERE LOWER(kitchen) = '{$shopTable}' AND order_status = 'delivered'";
...
<HEAD>
    ...
    <title>Invoices - <?= htmlspecialchars($shopDisplayName) ?></title>
...
<body class="bg-gray-50 text-gray-900">
    ...
    <script>
        ...
        function printInvoice(orderId) {
            ...
            const shopName = "<?= htmlspecialchars($shopDisplayName) ?>";
                ...
                <div style="font-family: 'Arial', sans-serif; max-width: 800px; margin: 0; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 10px; border-radius: 8px;">
                    ...
                    <div style="background: white; padding: 18px; border-radius: 10px; margin-bottom: 15px; box-shadow: 0 4px 15px rgba(0,0,0,0.1);">
                        <div style="text-align: center; margin-bottom: 15px;">
                            ...
                            <p style="color: #764ba2; font-size: 16px; margin: 3px 0 0 0; font-weight: 600;">${shopName}</p>
                        </div>
                    ...
                    <div style="text-align: center; margin-top: 15px; padding: 15px; background: rgba(255,255,255,0.1); border-radius: 10px;">
                        <p style="color: white; margin: 0; font-size: 13px;">Thank you for choosing Campus Cravings - ${shopName}!</p>
