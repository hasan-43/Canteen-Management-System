<?php
// admin/general/navbar.php
// Generalized admin homepage with statistics
...
$displayName = $_SESSION['fullname'] ?? $_SESSION['username'] ?? 'Admin';
...
<HEAD>
    ...
    <title>Home - <?= htmlspecialchars($shopDisplayName) ?> Admin - Campus Cravings</title>
    ...
    <section id="hero" class="hero">
        ...
        <div class="hero-content">
            <div class="max-w-4xl mx-auto px-4 text-center">
                ...
                <p class="text-gray-200 mb-6">Manage <?= htmlspecialchars($shopDisplayName) ?> — track statistics, products, and orders.</p>
            </div>
        </div>
    </section>
